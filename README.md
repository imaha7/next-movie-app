...
A [live deployment](https://next-movie-app-three.vercel.app/) of this app is available to try it out.
...
```bash 
  git clone https://github.com/imaha7/next-movie-app.git
  cd next-movie-app
  npm install
```
...
- [@imaha7](https://github.com/imaha7)
